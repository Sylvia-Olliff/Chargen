    ...
    override fun loadEntries() {
        for (prop in BaseRaces::class.memberProperties) {
            prop.get(BaseRaces)?.let {
                val race: RaceData = it as RaceData
                dataSet.add(race)
            }
        }
    }
